...
<script src="http://demo.itsolutionstuff.com/plugin/jquery.js"></script>
    ...
    <title>Simbaa's Cafe - Restaurant HTML Template</title>
<!--
                    ...
                    <nav class="main-nav">
                        ...
                        -->
                           ...
                           <li class="scroll-to-section"><a href="#chefs">Chefs</a></li> 
                            ...
                            <li class="scroll-to-section" style="padding-top:0.5em;" >
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>Simba's Cafe is one of the best <a href="https://templatemo.com/tag/restaurant" target="_blank" rel="sponsored">restaurant HTML templates</a> with Bootstrap v4.5.2 CSS framework. You can download and feel free to use this website template layout for your restaurant business. You are allowed to use this template for commercial purposes. <br><br>You are NOT allowed to redistribute the template ZIP file on any template donwnload website. Please contact us for more information.</p>
                        <div class="row">
                            <div class="col-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="scroll-to-section">
                        <a href="#top"><img src="assets/images/klassy-logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        <p>© Copyright Simba's Cafe Co.
